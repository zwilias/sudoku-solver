...
var _user$project$Sudoku_Board$join = function (maybe) {
	var _p0 = maybe;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Sudoku_Board$stringifyRow = function (_p1) {
	return A2(
		_elm_lang$core$String$join,
		' | ',
		A2(
				...
				A2(
					...
					function (_p2) {
						return A2(
							_elm_lang$core$Maybe$withDefault,
							' ',
							A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, _p2));
					},
					_p1))));
};
var _user$project$Sudoku_Board$toOffset = function (_p3) {
	var _p4 = _p3;
	return _p4.col + (9 * _p4.row);
};
var _user$project$Sudoku_Board$get = F2(
	function (position, _p5) {
		var _p6 = _p5;
		return _user$project$Sudoku_Board$join(
			A2(
				_Skinney$elm_array_exploration$Array_Hamt$get,
				_user$project$Sudoku_Board$toOffset(position),
				_p6._0));
	});
var _user$project$Sudoku_Board$row = F2(
	function (row, board) {
		return A2(
			_elm_lang$core$List$map,
			A2(_elm_lang$core$Basics$flip, _user$project$Sudoku_Board$get, board),
			A2(
				_elm_lang$core$List$map,
				function (col) {
...
var _user$project$Sudoku_Board$rows = function (board) {
	return A2(
		_elm_lang$core$List$map,
		A2(_elm_lang$core$Basics$flip, _user$project$Sudoku_Board$row, board),
		A2(_elm_lang$core$List$range, 0, 8));
};
var _user$project$Sudoku_Board$stringify = function (_p7) {
	return A2(
		_elm_lang$core$String$join,
		'\n',
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Sudoku_Board$stringifyRow,
						_user$project$Sudoku_Board$rows(_p7))))));
};
var _user$project$Sudoku_Board$column = F2(
	function (col, board) {
		return A2(
			_elm_lang$core$List$map,
			A2(_elm_lang$core$Basics$flip, _user$project$Sudoku_Board$get, board),
...
var _user$project$Sudoku_Board$square = F2(
	function (_p8, board) {
		var _p9 = _p8;
		var lowerRow = ((_p9.row / 3) | 0) * 3;
		var lowerCol = ((_p9.col / 3) | 0) * 3;
		return A2(
			_elm_lang$core$List$concatMap,
			function (col) {
				return A2(
					...
					A2(
						...
						A2(_elm_lang$core$List$range, lowerRow, lowerRow + 2)));
			},
			A2(_elm_lang$core$List$range, lowerCol, lowerCol + 2));
	});
var _user$project$Sudoku_Board$isValidRange = function (xs) {
	var listLength = _elm_lang$core$List$length(xs);
	return _elm_lang$core$Native_Utils.eq(listLength, 0) ? false : A2(
		F2(
			function (x, y) {
				return _elm_lang$core$Native_Utils.eq(x, y);
			}),
...
var _user$project$Sudoku_Board$isValidColumn = F2(
	function (col, board) {
		return _user$project$Sudoku_Board$isValidRange(
			A2(
...
var _user$project$Sudoku_Board$isValidRow = F2(
	function (row, board) {
		return _user$project$Sudoku_Board$isValidRange(
			A2(
				_elm_lang$core$List$filterMap,
...
var _user$project$Sudoku_Board$isValidSquare = F2(
	function (_p10, board) {
		var _p11 = _p10;
		var lowerRow = ((_p11.row / 3) | 0) * 3;
		var lowerCol = ((_p11.col / 3) | 0) * 3;
		return _user$project$Sudoku_Board$isValidRange(
			A2(
				_elm_lang$core$List$concatMap,
				function (col) {
...
var _user$project$Sudoku_Board$Position = F2(
	function (a, b) {
		return {row: a, col: b};
	});
var _user$project$Sudoku_Board$Board = function (a) {
	return {ctor: 'Board', _0: a};
};
var _user$project$Sudoku_Board$set = F3(
	function (position, value, _p12) {
		var _p13 = _p12;
		return _user$project$Sudoku_Board$Board(
			A3(
...
var _user$project$Sudoku_Solver$getOptions = F2(
	function (_p0, board) {
		var _p1 = _p0;
		var range = _elm_lang$core$Set$fromList(
			A2(_elm_lang$core$List$range, 1, 9));
		var usedOptions = _elm_lang$core$Set$fromList(
			A2(
				_elm_lang$core$List$filterMap,
				...
				_elm_lang$core$List$concat(
					{
						ctor: '::',
						_0: A2(_user$project$Sudoku_Board$row, _p1.row, board),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Sudoku_Board$column, _p1.col, board),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Sudoku_Board$square, _p1, board),
								_1: {ctor: '[]'}
							}
						}
					})));
		return _elm_lang$core$Set$toList(
			A2(_elm_lang$core$Set$diff, range, usedOptions));
	});
var _user$project$Sudoku_Solver$verify = F3(
	function (pos, val, oldBoard) {
		var board = A3(_user$project$Sudoku_Board$set, pos, val, oldBoard);
		return (A2(_user$project$Sudoku_Board$isValidRow, pos.row, board) && (A2(_user$project$Sudoku_Board$isValidColumn, pos.col, board) && A2(_user$project$Sudoku_Board$isValidSquare, pos, board))) ? _elm_lang$core$Maybe$Just(board) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Sudoku_Solver$emptyPositions = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$List$filterMap,
		function (_p4) {
		...
		_Skinney$elm_array_exploration$Array_Hamt$toIndexedList(_p3._0));
};
var _user$project$Sudoku_Solver$Solved = function (a) {
	return {ctor: 'Solved', _0: a};
};
var _user$project$Sudoku_Solver$Failure = {ctor: 'Failure'};
var _user$project$Sudoku_Solver$solvePosition = F4(
	function (pos, options, rest, board) {
		solvePosition:
		while (true) {
			var _p8 = options;
			if (_p8.ctor === '[]') {
				return _user$project$Sudoku_Solver$Failure;
			} else {
				var _p12 = _p8._1;
				var _p9 = A3(_user$project$Sudoku_Solver$verify, pos, _p8._0, board);
				if (_p9.ctor === 'Nothing') {
					var _v6 = pos,
						_v7 = _p12,
						_v8 = rest,
					...
					rest = _v8;
					board = _v9;
					continue solvePosition;
				} else {
					var _p11 = _p9._0;
					var _p10 = A2(_user$project$Sudoku_Solver$solvePositions, _p11, rest);
					if (_p10.ctor === 'Solved') {
						return _user$project$Sudoku_Solver$Solved(_p10._0);
					} else {
						var _v11 = pos,
							_v12 = _p12,
							_v13 = rest,
...
var _user$project$Sudoku_Solver$solvePositions = F2(
	function (board, positions) {
		var _p13 = positions;
		if (_p13.ctor === '[]') {
			return _user$project$Sudoku_Solver$Solved(board);
		} else {
			var _p14 = _p13._0;
			return A4(
				_user$project$Sudoku_Solver$solvePosition,
				_p14,
				A2(_user$project$Sudoku_Solver$getOptions, _p14, board),
				_p13._1,
				board);
		}
	});
var _user$project$Sudoku_Solver$solve = function (board) {
	return A2(
		_user$project$Sudoku_Solver$solvePositions,
		board,
		_user$project$Sudoku_Solver$emptyPositions(board));
};

var _user$project$App$validBoard = _user$project$Sudoku_Board$Board(
			...
			A2(
				...
				function (x) {
					return A2(
						_elm_lang$core$List$map,
						function (i) {
							return A2(_elm_lang$core$Basics_ops['%'], x + i, 9) + 1;
						},
						A2(_elm_lang$core$List$range, 0, 8));
				},
				A2(
					...
					function (x) {
						return A2(
							_elm_lang$core$List$map,
							function (i) {
								return A2(_elm_lang$core$Basics_ops['%'], i * 3, 9) + x;
							},
							A2(_elm_lang$core$List$range, 0, 2));
					},
					A2(_elm_lang$core$List$range, 0, 2))))));
var _user$project$App$boardToSolve = _user$project$Sudoku_Board$Board(
	_Skinney$elm_array_exploration$Array_Hamt$fromList(
		_elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Maybe$Just(9),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Maybe$Nothing,
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Maybe$Just(7),
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Maybe$Just(6),
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Maybe$Nothing,
													_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Maybe$Just(4),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Maybe$Nothing,
								_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$core$Maybe$Just(5),
														_1: {
															ctor: '::',
															_0: _elm_lang$core$Maybe$Just(6),
															_1: {
...
var _user$project$App$solve = function (board) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
		A2(
			_elm_lang$core$Task$map,
			function (_p0) {
				return _user$project$Sudoku_Solver$solve(board);
			},
			_elm_lang$core$Time$now));
};
var _user$project$App$emit = _elm_lang$core$Native_Platform.outgoingPort(
	'emit',
	function (v) {
		return v;
	});
var _user$project$App$emitBoard = function (board) {
	return _user$project$App$emit(
		_elm_lang$core$Json_Encode$string(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Attempting to solve:\n\n',
				_user$project$Sudoku_Board$stringify(board))));
};
var _user$project$App$emitSolution = function (solution) {
	var _p1 = solution;
	if (_p1.ctor === 'Solved') {
		return _user$project$App$emit(
			_elm_lang$core$Json_Encode$string(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'\n\nSolved!\n\n',
					_user$project$Sudoku_Board$stringify(_p1._0))));
	} else {
		return _user$project$App$emit(
			_elm_lang$core$Json_Encode$string('\n\nFailed :()'));
	}
...
var _user$project$App$update = F2(
	function (solution, _p2) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{ctor: '_Tuple0'},
			{
				ctor: '::',
				_0: _user$project$App$emitSolution(solution),
				_1: {ctor: '[]'}
			});
	});
var _user$project$App$main = _elm_lang$core$Platform$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{ctor: '_Tuple0'},
			{
				ctor: '::',
				_0: _user$project$App$solve(_user$project$App$boardToSolve),
				_1: {
					ctor: '::',
					_0: _user$project$App$emitBoard(_user$project$App$boardToSolve),
					_1: {ctor: '[]'}
				}
			}),
